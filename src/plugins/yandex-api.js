(function ymapsInit(e) {
  ...
  (t.modules = new o({
    ...
    fetchBundle: function (e) {
      ...
      (o.src = t.env.hosts["static"] + t.env.bundles[e]),
        ...
        o.setAttribute("data-ymaps-api-version", "2.1.79-10697605"),
        (o.async = !0);
      var i = t.vow.defer();
      return (
  ...
  enterprise: false,
  bundles: {
    full: "s3/front-maps-static/maps-front-jsapi-v2-1/2.1.79-10697605/build/release/full-6295ec9a3d8656b8095fa9a91d6d064cbd031ae1.js",
  },
  version: "2.1.79",
  tag: "2.1.79-10697605",
  ...
  server: {
    ...
    path: "build/release",
    params: { apikey: "Ваш_ключ", csp: null },
    version: "2.1",
  },
  preload: { load: "package.full", bundle: "full" },
  token: "2c1eed957648ec74a8d1a07250a9f571",
  taxiInceptionBboxes: [
    [
  ...
  vector: { version: "5.21.0", ts: 1675339305285 },
  hosts: {
    api: {
  ...
  layers: {
    ...
    sta: { version: "2023.02.01.22.29-1_23.01.31-0-13530" },
    stv: { version: "2023.02.01.22.29-1_23.01.31-0-13530" },
    trf: { version: "1675339200", scaled: true },
  ...
  geolocation: {
    ...
    span: { longitude: 0.177759, latitude: 0.101172 },
  },
});
